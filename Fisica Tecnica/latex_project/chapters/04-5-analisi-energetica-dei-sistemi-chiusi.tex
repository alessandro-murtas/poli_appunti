\hypertarget{bilancio-energetico-per-sistemi-chiusi}{%
\subsubsection{Bilancio energetico per sistemi
chiusi}\label{bilancio-energetico-per-sistemi-chiusi}}

Bilancio energetico per qualsiasi sistema che subisce qualunque tipo di
trasformazione:
...
\(Q=\dot Q\Delta t\), \(L=\dot L \Delta t\) e
\(\Delta E=(dE/dt)\Delta t\) Bilancio energetico per unità di massa:
...
\#\#\# Entalpia Posso calcolare il calore scambiato in una
trasformazione conoscendo l'entalpia iniziale e finale e la pressione e
il volume. \[Q_{1\to2}=H_2-H_1-\int_1^2 Vdp\] In una trasformazione
isobare quindi il calore scambiato è pari alla variazione di entalpia
\[Q_{p=\text{cost}}=H_2-H_1\] Il differenziale di entalpia lo posso
scrivere in 3 modi:
...
\#\#\#\# Entalpia di un gas perfetto \(H=U+pV=U+nR^*T=U+mRT\)
\(h=u+pv=u+R^*T=u+RT\) \(\Delta H=nc_p\Delta T\)
\(\Delta h=c_p\Delta T\)
