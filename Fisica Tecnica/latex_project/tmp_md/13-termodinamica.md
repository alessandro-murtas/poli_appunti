...
Calore specifico molare in gas poliatomici: $c_v=3R$, $c_p=4R$, $\gamma=\frac{4}{3}$
Lavoro: $$L_{AB}=\int_A^B p(V)dv$$
...
![](Ciclo Carnot pv.png)  ![](Ciclo Carnot ts.png)
...
![](Ciclo Otto pv.png)  ![](Ciclo Otto ts.png)
...
3. Espansione isoentropica
4. Trasformazione isocora
![](Ciclo Diesel pv.png)  ![](Ciclo Diesel ts.png)
...
![](Ciclo Brayton pv.png)  ![](Ciclo Brayton ts.png)

### Ciclo di Rankine
![](Ciclo Rankine ts.png)
...
![](Ciclo inverso vapore ideale.png)
