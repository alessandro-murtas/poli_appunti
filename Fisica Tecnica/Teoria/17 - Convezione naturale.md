### Numero di Grashof
$$\text{Gr }=\frac{F_\text{gall}F_\text{inerzia}}{(F_\text{visc})^2}=\frac{g\beta \Delta TL^3}{v^2}$$
...
Per:
- $\text{Ri} \gg 1$: Domina la **convezione naturale**
- $\text{Ri} \ll 1$: Domina la **convezione forzata**
- $\text{Ri} \approx 1$: **Convezione mista**